;(function (window) {
  ...
  let texts = ['TAP DIMANA AJA YA :)','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'HEY', 'COBA LIHAT DEH', 'KATA INI', 'KAYAKNYA ADA YANG ANEH', 'AYO PENCET LAGI', 'AKU GA BOHONG KOK', 'PENCET LAGI', 'AKU TAHU KAMU PASTI KESAL', 'TAPI INI BENER ADA YANG ANEH', 'AKU JANJI', 'INI TERAKHIR KALI', 'PENCET LAGI', 'AYO SEMANGAT SHASYALL', 'KAMU PASTI BISA', 'EHH KAMU KURANG PENCET ITU', 'AYO DONG', 'IYA INI BENER TERAKHIR KOK', 'YAUDAHH DEH', 'I', 'LOVE', 'YOU ♡', 'HAPPY VALENTINE DAY', 'BYE', 'MAAFIN AKU YA', 'KALO AKU BIKIN KAMU NANGIS', 'AKU SAYANG KAMU SHASYALL']
